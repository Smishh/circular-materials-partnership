...
Explore our Knowledge Center for industry insights and our Materials Eco Store for sustainable construction products. By partnering with us, you can benefit from our expertise in delivering solutions that prioritize sustainability, resilience, and environmental responsibility. Together, we can build resilient infrastructure while minimizing environmental impact.</p>
      ...
      <section className="py-24 bg-white px-4 relative">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="mb-8 rounded-lg border shadow-sm bg-card">
            <Collapsible>
                  ...
                  <div className="rounded-full p-2 hover:bg-muted">
                    <ChevronDown 
                      className={`h-6 w-6 text-primary transition-transform duration-200 ${
                        openCategories.includes('structural') ? 'rotate-180' : ''
                      }`} 
                    />
                  </div>
                </CollapsibleTrigger>
          ...
          <div className="mb-8 rounded-lg border shadow-sm bg-card">
            <Collapsible>
              <div className="flex items-center justify-between p-6 cursor-pointer"
                   onClick={() => toggleCategory('project-management')}>
                <h3 className="text-2xl font-semibold text-primary">Project Management</h3>
                <CollapsibleTrigger asChild>
                  <div className="rounded-full p-2 hover:bg-muted">
                    <ChevronDown 
                      className={`h-6 w-6 text-primary transition-transform duration-200 ${
                        openCategories.includes('project-management') ? 'rotate-180' : ''
                      }`} 
                    />
                  </div>
                </CollapsibleTrigger>
