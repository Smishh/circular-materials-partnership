...
import { Building2, Recycle, LineChart, Car, Mail, Phone, List, Briefcase, ChevronDown, ChevronUp } from "lucide-react";
...
Explore our Knowledge Center for industry insights and our Materials Eco Store for sustainable construction products. By partnering with us, you can benefit from our expertise in delivering solutions that prioritize sustainability, resilience, and environmental responsibility. Together, we can build resilient infrastructure while minimizing environmental impact.</p>
      ...
      <section className="py-24 bg-white px-4 relative">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="mb-16">
            <Collapsible open={openSections.civilStructural} onOpenChange={() => toggleSection('civilStructural')}>
              <CollapsibleTrigger className="w-full">
                <div className="flex items-center justify-between mb-8 bg-primary/5 p-4 rounded-lg cursor-pointer">
                  <h3 className="text-2xl font-semibold text-primary text-left">Civil and Structural Engineering</h3>
                  {openSections.civilStructural ? <ChevronUp className="text-primary" /> : <ChevronDown className="text-primary" />}
                </div>
              </CollapsibleTrigger>
              <CollapsibleContent>
                <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
                  <div ref={addToRefs} className="reveal rounded-xl overflow-hidden bg-gradient-to-br from-[#D3E4FD] to-[#A2C4F5] hover:from-[#C0D6F3] hover:to-[#8EB3E6] transition-colors hover-lift service-card">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-zinc-800">We take responsibility for the design of structures on your project, from planning, concept design, detailed design, supervision and completion. Review our previous projects here.</p>
                    </div>
                  </div>

                  {/* Buildings and Residential Design card */}
                  <div ref={addToRefs} className="reveal rounded-xl overflow-hidden bg-gradient-to-br from-[#F2FCE2] to-[#C6E6C5] hover:from-[#E2ECD2] hover:to-[#B6D6B5] transition-colors hover-lift service-card">
                    <AspectRatio ratio={16 / 9}>
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-zinc-800">Comprehensive residential design with sustainable building systems</p>
                    </div>
                  </div>
                  ...
                  <div ref={addToRefs} className="reveal rounded-xl overflow-hidden bg-gradient-to-br from-[#F2FCE2] to-[#C6E6C5] hover:from-[#E2ECD2] hover:to-[#B6D6B5] transition-colors hover-lift service-card">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-zinc-800">Transport Impact Assessment, Master Planning, and Road Safety Audits</p>
                    </div>
                  </div>
                  ...
                  <div ref={addToRefs} className="reveal rounded-xl overflow-hidden bg-gradient-to-br from-[#D3E4FD] to-[#A2C4F5] hover:from-[#C0D6F3] hover:to-[#8EB3E6] transition-colors hover-lift service-card">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-zinc-800">Civil Engineering, Condition Assessments, and Asset Management</p>
                    </div>
                  </div>
                </div>
              </CollapsibleContent>
          ...
          <div className="mb-16">
            <Collapsible open={openSections.projectManagement} onOpenChange={() => toggleSection('projectManagement')}>
              <CollapsibleTrigger className="w-full">
                <div className="flex items-center justify-between mb-8 bg-primary/5 p-4 rounded-lg cursor-pointer">
                  <h3 className="text-2xl font-semibold text-primary text-left">Project Management</h3>
                  {openSections.projectManagement ? <ChevronUp className="text-primary" /> : <ChevronDown className="text-primary" />}
                </div>
              </CollapsibleTrigger>
              <CollapsibleContent>
                <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
                  <div ref={addToRefs} className="reveal rounded-xl overflow-hidden bg-gradient-to-br from-[#F5E1C1] to-[#E8D0A9] hover:from-[#E8D0A9] hover:to-[#D6BF97] transition-colors hover-lift service-card">
                    <AspectRatio ratio={16 / 9}>
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-zinc-800">Strategic project planning, scheduling, and monitoring for optimal delivery</p>
                    </div>
                  </div>
                  ...
                  <div ref={addToRefs} className="reveal rounded-xl overflow-hidden bg-gradient-to-br from-[#F5E1C1] to-[#E8D0A9] hover:from-[#E8D0A9] hover:to-[#D6BF97] transition-colors hover-lift service-card">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-zinc-800">Comprehensive construction supervision and contract administration</p>
                    </div>
                  </div>
                </div>
              </CollapsibleContent>
          ...
          <div>
            <Collapsible open={openSections.sustainabilityProcess} onOpenChange={() => toggleSection('sustainabilityProcess')}>
              <CollapsibleTrigger className="w-full">
                <div className="flex items-center justify-between mb-8 bg-primary/5 p-4 rounded-lg cursor-pointer">
                  <h3 className="text-2xl font-semibold text-primary text-left">Sustainability and Process Engineering</h3>
                  {openSections.sustainabilityProcess ? <ChevronUp className="text-primary" /> : <ChevronDown className="text-primary" />}
                </div>
              </CollapsibleTrigger>
              <CollapsibleContent>
                <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
                  <div ref={addToRefs} className="reveal rounded-xl overflow-hidden bg-gradient-to-br from-[#C6E6D4] to-[#A3D1B8] hover:from-[#B4D6C5] hover:to-[#91C3A6] transition-colors hover-lift service-card">
                    <AspectRatio ratio={16 / 9}>
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-zinc-800">Life Cycle Assessment, Carbon Footprinting, and Carbon Tax Consulting</p>
                    </div>
                  </div>
                  ...
                  <div ref={addToRefs} className="reveal rounded-xl overflow-hidden bg-gradient-to-br from-[#C6E6D4] to-[#A3D1B8] hover:from-[#B4D6C5] hover:to-[#91C3A6] transition-colors hover-lift service-card">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-zinc-800">Industrial Waste Utilization and Construction Materials Advisory</p>
                    </div>
                  </div>
                </div>
              </CollapsibleContent>
