        ...
        <div className="container mx-auto text-center z-10">
          <div ref={addToRefs} className="reveal">
            ...
            <div className="w-full max-w-4xl mx-auto bg-white/95 backdrop-blur-sm py-4 px-6 md:px-8 rounded-xl shadow-md">
              <p className="text-sm md:text-base font-normal leading-relaxed text-zinc-800">Welcome to Circular Materials and Infrastructure Group - a built environment engineering company specializing in civil structural engineering and sustainable built environment practice. We are committed to shaping sustainable infrastructure through innovative technologies and a people-centric approach. Our services include design, condition assessment, maintenance, asset management, eco-friendly materials, and optimized processes.


Explore our Knowledge Center for industry insights and our Materials Eco Store for sustainable construction products. By partnering with us, you can benefit from our expertise in delivering solutions that prioritize sustainability, resilience, and environmental responsibility. Together, we can build resilient infrastructure while minimizing environmental impa</p>
            </div>
