        ...
        <div className="container mx-auto text-center z-10">
          <div ref={addToRefs} className="reveal">
            ...
            <div className="w-full bg-white py-4 rounded-md">
              <p className="text-base md:text-lg text-black font-medium max-w-3xl mx-auto">Dear vistor, thank you for visiting our website. The site is updated frequently as our services expand.
