      ...
      <Card className="w-full max-w-4xl mx-auto">
        <CardContent className="p-8">
          <article className="prose prose-slate max-w-none">
            <h1 className="text-3xl font-bold text-primary mb-2">Empowering Self-Builders with Affordable Structural Engineering</h1>
            <p className="text-lg italic text-muted-foreground mb-6">Building safe, durable homes that last generations</p>
