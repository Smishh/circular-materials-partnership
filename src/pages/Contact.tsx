  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        const isConnectionIssue = errorString.includes('Failed to fetch') || 
                                 errorString.includes('Network error') ||
                                 errorString.includes('FunctionsFetchError');
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="md:col-span-2">
          ...
          {showFallbackMessage && (
            <Alert className={`mb-6 ${connectionError ? 'bg-yellow-50 border-yellow-200' : 'bg-blue-50 border-blue-200'}`}>
              ...
              <AlertDescription className={connectionError ? "text-yellow-700" : "text-blue-700"}>
                {connectionError 
                  ? "Our email service is temporarily unavailable. We've recorded your message, but for immediate assistance, please contact us directly using any of the methods below."
                  : "Thank you for your message. For faster assistance, you can also reach us through:"}
              </AlertDescription>
            </Alert>
          )}
